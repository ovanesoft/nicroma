...
const carpetaRoutes = require('./routes/carpetas');
const clienteRoutes = require('./routes/clientes');
const prefacturaRoutes = require('./routes/prefacturas');
...
// Body parser con límites de tamaño (3MB para permitir logos en base64)
...
// Ruta pública del portal (sin autenticación)
const tenantController = require('./controllers/tenantController');
app.get('/api/portal-info/:portalSlug', tenantController.getPortalInfo);
